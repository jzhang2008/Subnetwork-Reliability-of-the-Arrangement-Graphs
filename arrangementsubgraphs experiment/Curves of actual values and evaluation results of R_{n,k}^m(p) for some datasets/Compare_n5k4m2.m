%%
n=5;k=4;m=2;
contrastTest=[ones(60,1)*5 ones(60,1)*4 ones(60,1)*2 (0.2110:(1-0.2110)/59:1)']';
load('E:\Datasets\data542.mat')
dataSet=data(:,1:4);
flag=data(:,5);
...
%%
simu=data(152:(end-152)/59:end,5)';
%%
figure
...
axis([0.211 1 0 1]);
set(gca,'XTick',(0.211:(1-0.211)/6:1)*10000/10000);
suptitle('Selected parameters:n=5,k=4,m=2')