%%
n=5;k=4;m=3;
contrastTest=[ones(200,1)*5 ones(200,1)*4 ones(200,1) (0.0080:(1-0.0080)/199:1)']'; 
load('E:\Datasets\data543.mat') 
dataSet=data(:,1:4);
flag=data(:,5);
...
axis([0.008 0.8 0 1]); 
 set(gca,'XTick',(0.0080:(0.8-0.0080)/6:1)*10000/10000); 
 suptitle('Selected parameters:n=5,k=4,m=3')