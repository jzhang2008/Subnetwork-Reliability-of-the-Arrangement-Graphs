%%
n=6;k=5;m=2; 
contrastTest=[ones(60,1)*5 ones(60,1)*4 ones(60,1) (0.6530:(1-0.6530)/59:1)']'; 
load('E:\Datasets\data652.mat') 
dataSet=data(:,1:4);
flag=data(:,5);
...
%%
simu=data(1170:(end-1170)/59:end,5)'; 
%%
figure
...
axis([0.653 1 0 1]); 
set(gca,'XTick',(0.6530:(1-0.6530)/6:1)*10000/10000); 
suptitle('Selected parameters:n=6,k=5,m=2')