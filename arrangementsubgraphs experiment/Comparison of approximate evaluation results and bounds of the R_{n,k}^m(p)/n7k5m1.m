%%
n=7;k=5;m=1; 
load('E:\Datasets\data751.mat')
%%
P=(0.9790:(1-0.9790)/59:1); 
Iter=length(P);
...
%%
simu=data(32632:(end-32632)/59:end,5)'; 
%%
figure
...
axis([0.979 1 0 1]); 
set(gca,'XTick',(0.9790:(1-0.9790)/6:1)*10000/10000);
suptitle('Selected parameters:n=7,k=5,m=1')