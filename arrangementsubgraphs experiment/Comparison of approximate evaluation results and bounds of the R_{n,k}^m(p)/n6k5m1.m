%%
n=6;k=5;m=1;
load('E:\Datasets\data651.mat') 
%%
P=(0.9370:(1-0.9370)/59:1); 
Iter=length(P);
...
%%
simu=data(10185:(end-10185)/59:end,5)';
%%
figure
...
axis([0.937 1 0 1]); 
set(gca,'XTick',(0.9370:(1-0.9370)/6:1)*10000/10000); 
suptitle('Selected parameters:n=6,k=5,m=1')