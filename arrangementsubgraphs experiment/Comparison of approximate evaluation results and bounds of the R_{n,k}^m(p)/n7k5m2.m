%%
n=7;k=5;m=2;
load('E:\Datasets\data752.mat') 
%%
P=(0.8390:(1-0.8390)/59:1); 
Iter=length(P);
...
%%
simu=data(3329:(end-3329)/59:end,5)'; 
%%
figure
...
xlabel('Node reliability','FontSize',14);
ylabel('Probability of existing fault-free A_n_-_m_,_k_-_m subnetworks','FontSize',14);
axis([0.839 1 0 1]); 
set(gca,'XTick',(0.8390:(1-0.8390)/6:1)*10000/10000); 
suptitle('Selected parameters:n=7,k=5,m=2')