...
trainSet = dataSet542(temp(1:prePos),:)';
trainFlag = flag542(temp(1:prePos))';
testSet = dataSet542(temp(prePos+1:end),:)';
testFlag = flag542(temp(prePos+1:end))';
...
T_sim542=T_sim;
b542=b;
save('bp542','net','a','b','b542','T_sim542');
