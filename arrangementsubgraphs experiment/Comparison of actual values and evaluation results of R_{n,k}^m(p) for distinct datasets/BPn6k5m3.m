...
trainSet = dataSet653(temp(1:prePos),:)';
trainFlag = flag653(temp(1:prePos))';
testSet = dataSet653(temp(prePos+1:end),:)';
testFlag = flag653(temp(prePos+1:end))';
...
T_sim653=T_sim;
b653=b;
save('bp653-3','net','a','b','b653','T_sim653');
