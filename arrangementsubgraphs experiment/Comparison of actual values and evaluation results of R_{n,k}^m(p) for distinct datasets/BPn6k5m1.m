...
trainSet = dataSet651(temp(1:prePos),:)';
trainFlag = flag651(temp(1:prePos))';
testSet = dataSet651(temp(prePos+1:end),:)';
testFlag = flag651(temp(prePos+1:end))';
...
T_sim651=T_sim;
b651=b;
save('bp651','net','a','b','b651','T_sim651');
