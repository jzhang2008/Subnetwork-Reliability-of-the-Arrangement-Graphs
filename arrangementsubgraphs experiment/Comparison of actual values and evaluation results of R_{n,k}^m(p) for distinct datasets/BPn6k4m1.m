...
trainSet = dataSet641(temp(1:prePos),:)';
trainFlag = flag641(temp(1:prePos))';
testSet = dataSet641(temp(prePos+1:end),:)';
testFlag = flag641(temp(prePos+1:end))';
...
T_sim641=T_sim;
b641=b;
save('bp641','net','a','b','b641','T_sim641');
