...
trainSet = dataSet753(temp(1:prePos),:)';
trainFlag = flag753(temp(1:prePos))';
testSet = dataSet753(temp(prePos+1:end),:)';
testFlag = flag753(temp(prePos+1:end))';
...
T_sim753=T_sim;
b753=b;
save('bp753','net','a','b','b753','T_sim753');
