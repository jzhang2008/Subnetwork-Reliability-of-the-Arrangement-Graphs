...
trainSet = dataSet752(temp(1:prePos),:)';
trainFlag = flag752(temp(1:prePos))';
testSet = dataSet752(temp(prePos+1:end),:)';
testFlag = flag752(temp(prePos+1:end))';
...
T_sim752=T_sim;
b752=b;
save('bp752','net','a','b','b752','T_sim752');
