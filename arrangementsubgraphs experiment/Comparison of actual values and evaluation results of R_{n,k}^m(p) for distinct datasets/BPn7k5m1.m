...
trainSet = dataSet751(temp(1:prePos),:)';
trainFlag = flag751(temp(1:prePos))';
testSet = dataSet751(temp(prePos+1:end),:)';
testFlag = flag751(temp(prePos+1:end))';
...
T_sim751=T_sim;
b751=b;
save('bp751-3','net','a','b','b751','T_sim751','RMSE','RMSE2');
